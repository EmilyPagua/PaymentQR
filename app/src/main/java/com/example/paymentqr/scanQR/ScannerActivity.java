...
import com.example.paymentqr.CreatePayment;
import com.example.paymentqr.MainMenu;
...
*/
    ...
    public void handleResult(Result rawResult) {
       ...
       // "Contents = " + rawResult.getText() + ", Format = " + rawResult.getBarcodeFormat().toString()
        showMessageDialog("Código leido exitosamente. Desea continuar?");
    }
