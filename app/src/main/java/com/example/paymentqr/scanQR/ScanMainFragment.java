 ...
 */
public class ScanMainFragment extends Fragment implements View.OnClickListener, ScannerView.ScannerViewEventListener
{

    View btnOpenScannerInSeparateActivity, btnOpenEmbeddedScanner,
            btnOpenEmbeddedScannerFront, btnCloseScanner, embeddedScannerRoot, waitLabel;
